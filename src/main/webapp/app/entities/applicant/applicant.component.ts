...
export class ApplicantComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.applicantService
            ...
            .subscribe(
                (res: HttpResponse<IApplicant[]>) => this.paginateApplicants(res.body, res.headers),
    ...
    onSelect(applicant) {
        this.router.navigate([`/applicant/${applicant.id}/edit`]);
    }

    protected paginateApplicants(data: IApplicant[], headers: HttpHeaders) {
